<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeForm.aspx.cs" Inherits="AspNet_Lab.EmployeeForm" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="font-family:Arial">
                ...
                <tr>
                    <td></td>
                    <td> <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/SessionState1.aspx" Target="_blank">Click here</asp:HyperLink></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>
